...
class InterviewOrchestrator:
    ...
    def _system_prompt_template(
        ...
        return (
            ...
            "{resume}\n\n"
            "COMMUNICATION STYLE:\n"
            "Answer in natural spoken English, not written English.\n"
            "Use shorter sentences. Avoid formal transitions like \"therefore\",\n"
            "\"furthermore\", \"it is worth noting that\", \"in conclusion\",\n"
            "\"additionally\".\n"
            "Write the way a senior engineer would actually explain something\n"
            "to a colleague out loud - conversational, direct, a little informal.\n"
            "It's okay to start a sentence with \"So\", \"And\", \"But\", or \"Look\".\n"
            "Avoid bullet points when possible - prefer flowing explanation\n"
            "that sounds like speech.\n\n"
